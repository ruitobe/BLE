...
public class GenericCharacteristicTableRow extends TableRow implements View.OnClickListener, Animation.AnimationListener, SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener{
    ...
    public final static String ACTION_PERIOD_UPDATE = "com.rui.ble.util.ACTION_PERIOD_UPDATE";
    public final static String ACTION_ONOFF_UPDATE = "com.rui.ble.util.ACTION_ONOFF_UPDATE";
    public final static String ACTION_CALIBRATE = "com.rui.ble.util.ACTION_CALIBRATE";
    public final static String EXTRA_SERVICE_UUID = "com.rui.ble.util.EXTRA_SERVICE_UUID";
    public final static String EXTRA_PERIOD = "com.rui.ble.util.EXTRA_PERIOD";
    public final static String EXTRA_ONOFF = "com.rui.ble.util.EXTRA_ONOFF";
